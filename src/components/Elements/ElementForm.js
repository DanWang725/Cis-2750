...
const ElementForm = (props) => {
    ...
    useEffect(() => {
      ...
      let elements = (<div>
        ...
        <InputField styling='input-form-small input-form element-input-form' type="text" name="code" displayName="Element Code" inputValue={data} onInputValueChange={handleChange} validification={validateCode}/>
        <InputField styling='input-form element-input-form' type="text" name="name" displayName="Element Name" inputValue={data} onInputValueChange={handleChange} validification={validateName}/>
        <InputField styling='input-form  element-input-form' type="number" name="radius" displayName="Element Radius" inputValue={data} onInputValueChange={handleChange} validification={validateRadius}/>
        </div>
        <div className='display-inline element-input-form-divs'>
          <InputField styling='input-form-stacked element-input-form' type="text" name="colour1" displayName="Colour 1" inputValue={data} onInputValueChange={handleChange} validification={validateColour}/>
          <InputField styling='input-form-stacked element-input-form'type="text" name="colour2" displayName="Colour 2" inputValue={data} onInputValueChange={handleChange} validification={validateColour}/>
          <InputField styling='input-form-stacked element-input-form' type="text" name="colour3" displayName="Colour 3" inputValue={data} onInputValueChange={handleChange} validification={validateColour}/>
        </div>
        </div>)
      return (<div>
